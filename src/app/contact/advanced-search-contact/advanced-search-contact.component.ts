...
@Component({
  selector: 'app-advanced-search-contact',
  templateUrl: './advanced-search-contact.component.html',
  styleUrls: ['./advanced-search-contact.component.scss'],
  providers: [ContactService, UserService], 
})
export class AdvancedSearchContactComponent implements OnInit {
  contacts: Contact[] = [];
  ...
  onSearchContact(){
    ...
    this.contactService.advancedSearchContact(u)
    .then(result => {
      this.contacts = result;
      this.contactList = this.contacts;
      this.totalrecord = this.contactList.length;
